 ...
 * @ClassName:SegmentedGroup.java
 * @Package:module.view
 * @time:下午4:10:02 2014-12-7
 * @useage:android当中类似于 iOS7当中的segment
 */
public class SegmentedGroup extends RadioGroup{
    private final String TAG = "SegmentedGroup";
