 ...
 * @ClassName:SettingGesturePasswordActivity.java
 * @Package:vgod.shome
 * @time:下午3:44:43 2014-12-14
 * @useage:设置手势密码
 */
public class SettingGesturePasswordActivity extends Activity implements OnClickListener{
	
	private final String TAG = "SettingGesturePasswordActivity";
	...
	private void updatePreviewViews() {
		if (mChosenPattern == null)
			return;
		L.i("way", "result = " + mChosenPattern.toString());
		for (Cell cell : mChosenPattern) {
			L.i("way", "cell.getRow() = " + cell.getRow()
	...
	private void saveChosenPatternAndFinish() {
		L.d(TAG, "mChosenPattern = " + mChosenPattern.toString());
